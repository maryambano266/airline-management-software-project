            ...
            <div className="form-bottom1" style={{ color: "white" }}>
                <form  onSubmit={handleSubmit}className="flight-search-form">
                    ...
                    <div className="row">
                        ...
                        <div className="form-group col-lg-4"  style={{color:"black"}}>
                            <label htmlFor="date" style={{color:"white"}}>Departure date</label>
                    ...
                    <div className="row">
                        ...
                        <div className="form-group col-lg-4 ab">
                            <label htmlFor="people" style={{color:"white"}}>No. of People</label>
